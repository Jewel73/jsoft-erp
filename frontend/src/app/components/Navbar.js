...
export default function Navbar() {
  ...
  return (
    <Fragment>
        <nav className="bg-white border border-b-slate-300 px-2 sm:px-4 py-2.5 ">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
            <a href="https://flowbite.com/" className="flex items-center">
                <span className="font-bold font-mono ring-2 ring-slate-400 rounded-md ring-opacity-20 hover:ring-opacity-70 self-center text-xl  whitespace-nowrap ">jsoft</span>
            </a>
            ...
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
                <li>
                <Link to={"/home"} href="#" className="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">Home</Link>
                </li>
                <li>
                ...
                <li>
                    <button className=' transform transition text-lime-50 rounded hover:ring ring-3 ring-purple-200 bg-red'>{userName?userName: "Login"}</button>
                </li>
            </ul>
